...
public static class Database
{
    ...
    ThreadRecord thread)
    {
        ...
        command.Parameters.AddWithValue(
            "$subject",
            (object?)thread.Subject ?? DBNull.Value);

        command.Parameters.AddWithValue(
            "$firstDate",
            (object?)thread.FirstDate ?? DBNull.Value);

        command.Parameters.AddWithValue(
            "$lastDate",
            (object?)thread.LastDate ?? DBNull.Value);

        command.Parameters.AddWithValue(
            "$name",
            (object?)thread.Name ?? DBNull.Value);
        ...
        ThreadRecord thread)
    {
        ...
        command.Parameters.AddWithValue(
            "$firstDate",
            (object?)thread.FirstDate ??
            DBNull.Value);

        command.Parameters.AddWithValue(
            "$lastDate",
            (object?)thread.LastDate ??
            DBNull.Value);
    ...
    */
    ...
    public static async Task<List<EmlRepairRecord>>
    GetMessagesForEmlValidationAsync(
        string databasePath)
    {
        var result =
            new List<EmlRepairRecord>();
    ...
    """;
        ...
        command.Parameters.AddWithValue(
            "$attachmentNames",
            (object?)message.AttachmentNames
            ?? DBNull.Value);
